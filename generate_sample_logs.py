...
print("🔄 Generating sample server logs (10,000 entries)...")
# Generate smaller sample for testing (10k instead of 1M)
f = open("sample-server-logs.log","w")
...
f.close()
print("✅ Generated sample-server-logs.log with 10,000 entries")
